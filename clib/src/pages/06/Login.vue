    ...
    <div class="loginWrap">
      <div class="loginBox">
        ...
        <div>
          ...
          <span>
            <linkComponent :linkNm="'사번 찾기'" @click="findIdModal" />
          </span>
          <span>
            <linkComponent :linkNm="'비밀번호 찾기'" @click="findPwModal" />
          </span>
        </div>
...
.container {
  ...
  height: 100vh;
  display: grid;
  grid-template-columns: minmax(0px, 15%) minmax(600px, 40%) minmax(500px, 30%) minmax(
      0px,
      15%
    );
